...
* Moves files that don't fit into any predefined folders into the "OTHER" folder
How to use
...
3. The "OTHER" folder will be created in the selected folder and all remaining files will be moved there.
